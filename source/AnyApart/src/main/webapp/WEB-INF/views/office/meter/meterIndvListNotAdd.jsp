...
<!-- 						</tr> -->
						...
						<tr>
							<td><input type="number" name="indvYear" required class="form-control"></td>
							<td><input type="number" name="indvMonth" required class="form-control"></td>
							<td><input type="number" name="indvHeat" required class="form-control"></td>
							<td><input type="number" name="indvHotwater" required class="form-control"></td>
							<td><input type="number" name="indvWater" required class="form-control"></td>
							<td><input type="number" name="indvElec" required class="form-control"></td>
...
$("#insertAddBtn").on("click", function(){
	...
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvYear' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvMonth' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvHeat' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvHotwater' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvWater' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='number' name='indvElec' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
			$("<input type='text' name='memId' required class='form-control'>")		
		)	
	);
	tr.append(
		$("<td>").append(
