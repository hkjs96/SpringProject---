...
<div class="container">
	<div class="col-sm-6" style="border-style: outset; border-radius: 8px; margin-left: 17em;">
		<div class="row g-0">
			<div>
				<!-- 서버 -->
				<form id="searchForm">
			...
			<tbody id="listBody">
				...
				<c:if test="${not empty boardList }">
					<c:forEach items="${boardList }" var="board" varStatus="vs">
						<tr data-bo-no='${board.boNo }' class="text-center">
<!-- 							<td><input type="checkbox" /></td> -->
							<td>${pagingVO.totalRecord - vs.index - pagingVO.screenSize*(pagingVO.currentPage-1) }</td>
							<td class="text-left">${board.boTitle } [${board.repCnt}]</td>
