                ...
                <!-- 중분류 -->
                     <div class="collapse" id="collapseCar" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             ...
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/carO/carInOutList.do">차량 입출차 현황</a>
                         </nav>
                     </div>
             ...
             <!-- ---------------- 일정관리 ---------------->
				...
				<!-- 중분류 -->				
                     <div class="collapse" id="collapseCalendar" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${cPath}/office/calendar/wholeCalendar.do">아파트 전체일정</a>
                         </nav>
                     </div>  
 			 ...
 			 <!-- ---------------- 공사/수선관리 ---------------->
				...
				<!-- 중분류 -->				
                     <div class="collapse" id="collapseConstruction" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             <a class="nav-link" href="${cPath}/office/construction/afterServiceList.do">수리관리</a>
                         </nav>
                     </div>        
				<!-- 중분류 -->				
                     <div class="collapse" id="collapseConstruction" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                ...
                <!-- 중분류 -->
                     <div class="collapse" id="collapseAsset" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav">
                             ...
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/asset/repair/repairList.do">수리이력 관리</a>
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/asset/buy/buyList.do">구매이력 관리</a>
             ...
             <!-- ------------- 계약관리 ------------------->
 			 ...
 			 <!-- ---------------- 인사/근태관리 ---------------->
  			 ...
  			 <!-- ---------------- 급여/정산관리 ---------------->
				...
				<!-- 소분류 -->                             
                             <div class="collapse" id="salaryBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/payment/paymentBasicInfoList.do">급여기본정보</a>
  			 ...
  			 <!-- ---------------- 사이트관리 ---------------->
				...
				<!-- 중분류 -->                     
                     <div class="collapse" id="collapseSite" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                         <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                             <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#boardBox" aria-expanded="false" aria-controls="boardBox">
                               	일반게시판관리
                                 <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                             </a>
				<!-- 소분류 -->                             
                             <div class="collapse" id="boardBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
                ...
                <!-- 중분류 -->
                             <a class="nav-link" href="${pageContext.request.contextPath}/office/website/officeQna/officeQnaList.do">문의게시판관리</a>
                <!-- 중분류 -->
                             <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#communityBox" aria-expanded="false" aria-controls="communityBox">
                               	커뮤니티시설 예약관리
                                 <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                             </a>
				<!-- 소분류 -->                             
                             <div class="collapse" id="communityBox" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                 <nav class="sb-sidenav-menu-nested nav">
<%--                                      <a class="nav-link" href="${pageContext.request.contextPath}/office/website/reservation/reservationRequest.do">예약신청현황</a> --%>
                                     <a class="nav-link" href="${pageContext.request.contextPath}/office/website/reservation/reservationList.do">예약일정관리</a>
                                 </nav>
                             </div>
                         </nav>
                     </div>                                      
	...
	$('a').each(function() {
		...
		if (urlRegExp.test(href)) {
			...
			if (offset.top > 900) { // 관리비 메뉴 이후일때만 스크롤 작동
				navdiv.animate({scrollTop : offset.top}, 400);
			}
		}
	});
});
